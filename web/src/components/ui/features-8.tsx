...
import { Shield, Users, Package, TrendingUp, RefreshCw, BarChart3 } from 'lucide-react'
            ...
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                ...
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 bg-white dark:bg-black border-white dark:border-black hover:shadow-lg hover:shadow-white/50 dark:hover:shadow-black/50 transition-all">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center justify-center flex-col gap-3">
                                    <Shield className="size-16 text-black dark:text-white" strokeWidth={1.5} />
                                </div>
                                <h2 className="mt-6 text-center text-3xl font-semibold text-black dark:text-white">Enterprise Security</h2>
                                <p className="mt-2 text-center text-sm text-black dark:text-black px-4">Bank-level encryption & compliance</p>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-white dark:bg-black border-white dark:border-black hover:shadow-lg hover:shadow-white/50 dark:hover:shadow-black/50 transition-all">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-white dark:border-black before:absolute before:-inset-2 before:rounded-full before:border before:border-white dark:before:border-black bg-white dark:bg-black">
                                    <Package className="m-auto size-16 text-black dark:text-white" strokeWidth={1.5} />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition text-black dark:text-white">Multi-Warehouse Support</h2>
                                    <p className="text-black dark:text-black">Manage inventory across multiple locations with real-time synchronization and centralized control.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-white dark:bg-black border-white dark:border-black hover:shadow-lg hover:shadow-white/50 dark:hover:shadow-black/50 transition-all">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <div className="relative mx-auto flex aspect-square size-32">
                                        <TrendingUp className="m-auto size-20 text-black dark:text-white" strokeWidth={1.5} />
                                    </div>
                                </div>
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition text-black dark:text-white">Predictive Analytics</h2>
                                    <p className="text-black dark:text-black">AI-powered forecasting helps you predict demand, optimize stock levels, and prevent costly stockouts.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-white dark:bg-black border-white dark:border-black hover:shadow-lg hover:shadow-white/50 dark:hover:shadow-black/50 transition-all">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-white dark:border-black before:absolute before:-inset-2 before:rounded-full before:border before:border-white dark:before:border-black bg-white dark:bg-black">
                                        <RefreshCw className="m-auto size-5 text-black dark:text-white" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-black transition dark:text-white">Automated Reordering</h2>
                                        <p className="text-black dark:text-black">Set smart reorder points and let the system automatically create purchase orders when stock runs low.</p>
                                    </div>
                                </div>
                                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-white dark:border-black p-6 py-6 sm:ml-6 bg-white dark:bg-black/50">
                                    <div className="absolute left-3 top-2 flex gap-1">
                                        <span className="block size-2 rounded-full border border-white dark:border-black bg-black dark:bg-white0"></span>
                                        <span className="block size-2 rounded-full border border-white dark:border-black bg-white dark:bg-black"></span>
                                        <span className="block size-2 rounded-full border border-white dark:border-black bg-white dark:bg-black"></span>
                                    </div>
                                    <svg className="w-full sm:w-[150%]" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_0_705" x1="0.85108" y1="0.947876" x2="0.85108" y2="230.114" gradientUnits="userSpaceOnUse">
                                                <stop className="text-white0/20 dark:text-black/40" stopColor="currentColor" />
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-white dark:bg-black border-white dark:border-black hover:shadow-lg hover:shadow-white/50 dark:hover:shadow-black/50 transition-all">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-white dark:border-black before:absolute before:-inset-2 before:rounded-full before:border before:border-white dark:before:border-black bg-white dark:bg-black">
                                        <BarChart3 className="m-auto size-6 text-black dark:text-white" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition text-black dark:text-white">Advanced Reporting</h2>
                                        <p className="text-black dark:text-black">Gain deep insights with customizable reports, real-time dashboards, and detailed analytics on inventory performance.</p>
                                    </div>
                                </div>
                                <div className="before:bg-white dark:before:bg-black relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-green-50 dark:bg-green-950 text-green-700 dark:text-green-400 border-green-200 dark:border-green-800">+45% Efficiency</span>
                                            <div className="ring-white dark:ring-black size-7 ring-4 bg-green-500 dark:bg-green-600 rounded-full flex items-center justify-center">
                                                <TrendingUp className="size-4 text-white" strokeWidth={2} />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-white dark:ring-black size-8 ring-4 bg-white0 dark:bg-black rounded-full flex items-center justify-center">
                                                <BarChart3 className="size-5 text-white" strokeWidth={2} />
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-white dark:bg-black text-black dark:text-black border-white dark:border-black">Real-time Data</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-purple-50 dark:bg-purple-950 text-purple-700 dark:text-purple-400 border-purple-200 dark:border-purple-800">-40% Costs</span>
                                            <div className="ring-white dark:ring-black size-7 ring-4 bg-purple-500 dark:bg-purple-600 rounded-full flex items-center justify-center">
