...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = "default", size = "default", className = "", children, ...props }, ref) => {
    ...
    const variants = {
      ...
      secondary: "bg-black text-white hover:bg-black",
...
const Navigation = React.memo(() => {
  ...
  return (
    <header className="fixed top-0 w-full z-50 border-b border-black/50 bg-black/80 backdrop-blur-md">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-black/95 backdrop-blur-md border-t border-black/50 animate-[slideDown_0.3s_ease-out]">
          <div className="px-6 py-4 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 pt-4 border-t border-black/50">
              <Button type="button" variant="ghost" size="sm">
                Sign in
              </Button>
              <Button type="button" variant="default" size="sm">
...
const Hero = React.memo(() => {
  return (
    ...
    >
      ...
      <aside className="mb-8 inline-flex flex-wrap items-center justify-center gap-2 px-4 py-2 rounded-full border border-black bg-black/50 backdrop-blur-sm max-w-full">
